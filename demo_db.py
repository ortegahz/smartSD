...
def parse_args():
    ...
    parser.add_argument('--path_in',
                        default='/media/manu/data/docs/smokes/AI烟感资料整合-第一批/SONAR_TFS/pos/TF3_20220729155655_101001_data_export_003.xlsx')
...
def main():
    ...
    smoke_detector.plot_db(args.addrs_sensor, pause_time_s=64)
