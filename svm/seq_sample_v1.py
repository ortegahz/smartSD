...
from utils.utils import set_logging, db_gen_v1, plot_db_v1, LEN_SEQ, DEBUG_ALARM_INDICATOR_VAL, \
    update_svm_label_file, find_anchor_idxes_up
        ...
        for path_src in paths_src:
            ...
            for db in db_gen_v1(path_src):
                ...
                for anchor_idx in anchor_idxes_pick:
                    db['state'][anchor_idx - LEN_SEQ + 1] = DEBUG_ALARM_INDICATOR_VAL
                    db['state'][anchor_idx] = DEBUG_ALARM_INDICATOR_VAL
                    ...
                    if args.save_plot:
                        plot_db_v1(db, None, 0.1, subset, args.dir_plot_save, idx_save)
                    idx_save += 1
