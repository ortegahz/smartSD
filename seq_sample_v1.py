...
from utils import set_logging, db_gen_v1, plot_db_v1, make_dirs, find_key_idx, seq_pick_process, update_svm_label_file
    ...
    for subset in args.subsets:
        ...
        for path_src in paths_src:
            ...
            for db in db_gen_v1(path_src):
                ...
                if args.save_plot:
                    plot_db_v1(db, 0.1, subset, args.dir_plot_save, idx_save)
